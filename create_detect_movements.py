...
def check_tracking_to_bounding_boxes_loc_fix( get_count_tracking_prev,get_count_tracking_current ):
    ...
    if get_count_tracking_current < len(copy_rdframe.index):
        ...
        # print (names, "   tracking id", get_prev_lsa_index,"values   ", previous,
        ...
        # filltering out the names here according to the current tracking names 
        temp_dic_names = {}
        for key, value in zip(get_prev_lsa_index,names): 
